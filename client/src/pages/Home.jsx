    ...
    <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
       ...
       <section className='pt-44 pb-32 px-6 text-center'>
          ...
          >
            ...
            <span className='bg-linear-to-r from bg-purple-400 to-blue-400 bg-clip-text text-transparent'>with AI</span>
          </motion.h1>
          ...
          <button className='px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105 transition mt-4' onClick={() =>userData ? navigate("/dashboard") : setOpenLogin(true)}>{userData? "Go to Dashboard" : "Get Started"}</button>
       </section>
       ...
       {userData && websites?.length > 0 && (
        <section className='mx-w-7xl mx-auto px-6 pb-32'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            {websites.slice(0, 3).map((w, i) => (
              ...
              className='cursor-pointer rounded-2xl bg-white/5 border boder-white/10 overflow-hidden'
              >
