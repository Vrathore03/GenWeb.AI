...
function WebsiteEditor() {
  ...
  return (
    <div className='h-screen w-screen flex bg-black text-white overflow-hidden'>
        ...
        <div className='p-3 border-3 border-white/10'>
                <div className='flex gap-2'>
                    <input row="1" placeholder='Describe Changes...' className='flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 border border-whie/10 text-sm outline-none' onChange={(e)=>setPrompt(e.target.value)} value={prompt}/>
  ...
  function Header({onclose}) {
    return (
        <div className='h-14 px-4 flex items-center justify-between border-b border-white/10'>
            ...
            {onclose && <button onClick={onclose}><X color='white' size={18}/></button>}
