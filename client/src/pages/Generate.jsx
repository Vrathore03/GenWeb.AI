      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className='text-zinc-400 max-w-2xl mx-auto'>This process may take several minutes.
            GenWeb.AI focuses on quantity, not shortcuts.
          </p>
        </motion.div>
        <div className='mb-14'>
          ...
          <div className='relative'>
            <textarea onChange={(e)=>setPrompt(e.target.value)} value={prompt} placeholder='Describe your website in detail...' className='w-full h-56 p-6 rounded-3xl bg-black/60 boder border-white/10 outline-none resize-no text-sm leading-relaxed focus:ring-2 focus:ring-white/20'></textarea>
          </div>
